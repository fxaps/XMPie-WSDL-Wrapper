...
class OrderProduct extends ReturnObject
{
    ...
    /**
     * @param int $OrderProductID
     * @return \XMPieWsdlClient\XMPie\uStore\v_8_6\WSAPI\OrderProductWS\OrderProduct
     */
